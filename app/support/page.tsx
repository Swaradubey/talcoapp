            ...
            return (
              <div
                ...
                className={`glass-card rounded-2xl overflow-hidden border transition-all ${
                  isOpen ? 'border-blue-500/30 bg-white/[0.03]' : 'border-white/5'
                }`}
              >
                <button
                ...
                >
                  <span className="text-[var(--text)] text-sm font-bold pr-4 group-hover:text-white" style={{ fontFamily: 'Syne, sans-serif' }}>
                    {faq.q}
                  </span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="glass-card rounded-2xl p-6 bg-[var(--card)] border border-white/5 text-center flex flex-col justify-between h-48">
          <div>
            ...
            <h3 className="text-[var(--text)] text-sm font-extrabold mb-1.5" style={{ fontFamily: 'Syne, sans-serif' }}>Still Stuck?</h3>
        ...
        <div className="glass-card rounded-2xl p-6 bg-[var(--card)] border border-white/5 text-center flex flex-col justify-between h-48">
          <div>
            ...
            <h3 className="text-[var(--text)] text-sm font-extrabold mb-1.5" style={{ fontFamily: 'Syne, sans-serif' }}>Documentation</h3>
